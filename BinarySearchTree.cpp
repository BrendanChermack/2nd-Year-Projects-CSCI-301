...
BinaryNode<ItemType>* BinarySearchTree<ItemType>::removeValue( BinaryNode<ItemType>* subTreePtr,
    ...
    if ( subTreePtr->getItem() == target ) {
        ...
        {
            childPtr = removeValue( subTreePtr->getLeftChildPtr(), target, success );
            subTreePtr->setLeftChildPtr( childPtr );
        }

        else // Search the right subtree
        {
            childPtr = removeValue( subTreePtr->getRightChildPtr(), target, success );
            subTreePtr->setRightChildPtr( childPtr );
        }
